...
new_years_file = open("https://aa-file-upload-dev.s3.amazonaws.com/new_year.png")
...
blue_car = open("https://aa-file-upload-dev.s3.amazonaws.com/car.png")
...
TacoTuesday = Event.create!(event11()).picture.attach(io: blue_car, filename: "blue_car.jpg")
